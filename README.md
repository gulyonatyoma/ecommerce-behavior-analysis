...
В `ML/` хранится .ipynb с обучением ml-модели для предсказания покупки товара в течение 7 дней для пары "пользователь-товар" на данных за последние 30 дней; .pkl файл с указанием структуры весов обученной модели. Веса модели в формате .cbm находятся в Releases v1.0.0.

## ab

В `ab/` расположен .py файл с проведением АБ-теста для пользователей cart to purchase.
